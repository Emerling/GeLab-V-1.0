<?php if ($userInfo['type'] == 'Administrador') { ?>
    <div class="mdb-page-content text-center page-intro bg-light">
        <div class="card-group">
            <div class="card text-white bg-secondary mb-0">
                <i class="fas fa-id-card fa-3x card-img-top mt-3  "></i>
            ...
            <div class="card text-white bg-success mb-0">
                <i class="fas fa-vial fa-3x card-img-top mt-3 "></i>
                <div class="card-body">
            ...
            <div class="card text-white bg-info mb-0">
                <i class="fas fa-clipboard-list fa-3x card-img-top mt-3 "></i>
                <div class="card-body">
            ...
            <div class="card text-white bg-danger mb-0">
                <i class="fas fa-calculator fa-3x card-img-top mt-3 "></i>
                <div class="card-body">
    ...
    <!-- Background image -->
    <div class="p-0 bg-image" style="background-image: url('img/pagina.jpg');height: 310px;">
